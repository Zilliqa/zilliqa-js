...
ls $HOME/zilliqa-js-e2e

yarn add -D typescript@4.4.4
yarn add @zilliqa-js/zilliqa@e2e --registry http://localhost:4873
cat node_modules/@zilliqa-js/zilliqa/package.json

npx tsc index.ts --target es5 --noEmit --esModuleInterop --forceConsistentCasingInFileNames --strict --skipLibCheck false
